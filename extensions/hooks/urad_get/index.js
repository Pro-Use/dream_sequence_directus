...
var index = async ({ schedule }, {database, getSchema, env}) => {
	const config = {
		'headers': {
	...
	console.log(fields);
	schedule('* * * * *', async () => {
		let res = await axios$1.get('http://data.uradmonitor.com/api/v1/devices/82000202/all/60', config);
